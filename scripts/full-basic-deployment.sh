...
python3 benchmark_unnumbered_rest.py --file benchmark_unnumbered_20000.txt --base-url http://127.0.0.1:8001 --concurrency 64
...
python3 benchmark_rabbitmq.py --model unnumbered --file benchmark_unnumbered_20000.txt --rabbitmq-url amqp://guest:guest@127.0.0.1:5672/%2F --request-queue tickets.buy --inflight 256
